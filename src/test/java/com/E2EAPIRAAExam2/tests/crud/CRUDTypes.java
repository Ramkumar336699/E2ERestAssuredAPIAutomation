package com.E2EAPIRAAExam2.tests.crud;
...
public class CRUDTypes {
    ...
    public void testCreateBooking() throws JsonProcessingException {
        ...
        requestSpecification.basePath(com.E2EAPIAutomationPractice.endPoints.APIConstants.CREATE_BOOKING);
    ...
    public void testCreateToken() {
        ...
        requestSpecification.basePath(com.E2EAPIAutomationPractice.endPoints.APIConstants.CREATE_TOKEN);
        payloadManager = new PayloadManager();
        ValidatableResponse response = RestAssured.given().spec(requestSpecification)
